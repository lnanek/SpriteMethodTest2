...
import com.android.spritemethodtest.canvas.CanvasTestActivity;
import com.android.spritemethodtest.opengl.DrawMethod;
import com.android.spritemethodtest.opengl.OpenGLTestActivity;
    ...
    View.OnClickListener mRunTestListener = new OnClickListener() {
        public void onClick(View v) {
            ...
            if (group.getCheckedRadioButtonId() == R.id.methodCanvas) {
                ...
                DrawMethod method = 
                	DrawMethod.forRadio(glSettings.getCheckedRadioButtonId());
                i.putExtra("drawMethod", method.ordinal());
            }
            initializeIntent(i);
    ...
    RadioGroup.OnCheckedChangeListener mMethodChangedListener 
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
           if (checkedId == R.id.methodCanvas) {
	       		for ( DrawMethod method : DrawMethod.values() ) {
	       			findViewById(method.mRadioButtonID).setEnabled(false);
	    		}
           } else {
	       		for ( DrawMethod method : DrawMethod.values() ) {
	       			findViewById(method.mRadioButtonID).setEnabled(true);
	    		}
           }
        }
    };
